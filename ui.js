...
(function() {
    ...
    '<a href="/#products">Our Cookies</a><a href="/#gifts">Gift Boxes</a><a href="/#build">Build a Box</a><a href="kitchen.html">The Kitchen</a><a href="archive.html">Archive</a><a href="faq.html">FAQ</a><a href="/#order" style="color:var(--gold)">Order Now</a>' +
    '</div>' +
    ...
    '</div><div class="footer-bottom"><p>&copy; 2024–<span id="copyYear">2026</span> Big Cookies. Baked with love in Portland, OR &nbsp;&middot;&nbsp;<a href="mailto:hello@big-cookies.yaoyy.moe"><svg width="14" height="14" viewBox="0 0 24 24" style="vertical-align:-2px" aria-hidden="true"><use href="#icon-mail"/></svg> hello@big-cookies.yaoyy.moe</a></p></div></footer>';
