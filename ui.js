...
(function() {
    // ── SVG sprite defs ──
    const svgDefs = '<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true"><defs><symbol id="icon-star" viewBox="0 0 24 24"><path d="M12 2l2.8 6.6L22 9.5l-5 5.4 1.5 7.1-6.5-3.8-6.5 3.8L7 14.9l-5-5.4 7.2-.9L12 2z" fill="currentColor"/></symbol><symbol id="icon-star-empty" viewBox="0 0 24 24"><path d="M12 2l2.8 6.6L22 9.5l-5 5.4 1.5 7.1-6.5-3.8-6.5 3.8L7 14.9l-5-5.4 7.2-.9L12 2z" fill="none" stroke="currentColor" stroke-width="0.8"/></symbol><symbol id="icon-mail" viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="16" rx="2" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M2 6l10 7 10-7" fill="none" stroke="currentColor" stroke-width="1.5"/></symbol><symbol id="icon-reset" viewBox="0 0 24 24"><path d="M1 4v6h6" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.5 15.5a9 9 0 102.8-8.2L1 10" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol></defs></svg>';
